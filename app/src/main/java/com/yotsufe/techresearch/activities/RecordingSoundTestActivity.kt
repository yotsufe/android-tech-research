...
import com.yotsufe.techresearch.databinding.ActivityRecordingSoundTestBinding
import com.yotsufe.techresearch.models.Base64Encoder
import kotlinx.android.synthetic.main.activity_recording_sound_test.*
import java.io.File
import java.io.IOException

class RecordingSoundTestActivity : AppCompatActivity() {

    private lateinit var binding: ActivityRecordingSoundTestBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this,
            R.layout.activity_recording_sound_test
        )
        ...
        player = MediaPlayer().apply {
            try {
                ...
                setOnCompletionListener {
                    ...
                    this@RecordingSoundTestActivity.isPlaying = false
                    player = null
                ...
                binding.currentTime.start()
                start()
                this@RecordingSoundTestActivity.isPlaying = true
            } catch (e: IOException) {
